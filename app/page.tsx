...
<main className="mx-auto max-w-6xl px-4 sm:px-6 pt-4 sm:pt-12 pb-4 sm:pb-10">
  {/* ✅ MOBILE: 1 schermata */}
  <div className="min-h-[calc(100svh-90px)] sm:min-h-0 flex flex-col gap-3 sm:block sm:gap-0">
    ...
    <div className="grid gap-3 sm:gap-6 lg:grid-cols-2 lg:items-start">
      ...
      <section className="space-y-3 sm:space-y-4">
        ...
        {/* ✅ Titolo più “fit” su mobile */}
        <h1 className="text-balance text-[34px] leading-[1.05] font-semibold tracking-tight sm:text-5xl lg:text-6xl">
          I colori che ti stanno bene.
          <br />
          <span className="text-white/75">In 5 secondi.</span>
        </h1>

        <p className="max-w-xl text-[14px] leading-6 text-white/70 sm:text-[15px] sm:leading-7">
